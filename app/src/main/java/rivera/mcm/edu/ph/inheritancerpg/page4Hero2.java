        ...
        btn4.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        else if (value.equals("Alchemist")){
                        ...
                        else if (value.equals("White Mage")){
